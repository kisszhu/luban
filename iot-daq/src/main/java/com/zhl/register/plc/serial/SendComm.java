package com.zhl.register.plc.serial;

/**
 * @program codeX
 * @description:从串行口COM1中发送数据
 * @author: meilong
 * @create: 2019/07/22 10:32
 */
...
public class SendComm extends Thread implements SerialPortEventListener {
